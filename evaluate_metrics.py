...
if __name__=="__main__":
    ...
    # normalize poses by first pose
    #gt_pose_norm = dict([ (key, tum_utils.transform_diff(gt_pose[gt_pose.keys()[0]], gt_pose[key])) for key in gt_pose])
    #est_pose_norm = dict([ (key, tum_utils.transform_diff(est_pose[est_pose.keys()[0]], est_pose[key])) for key in est_pose])
    #print(gt_pose)
